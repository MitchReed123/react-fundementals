  ...
  return (
    <div className="main">
      <div className="mainDiv">
        ...
        <p>
          This is app is intended to be a strater/tutorial app for your upcoming
          project and a learning sandbox for you in months and years to come
          should continue to develop software with React. In this application we
          will work through some of the basic React concepts, build out some
          small applications, and the unleash you to build your own
          applications.
        </p>
        <hr />
        ...
        <ul>
          ...
          <li>
            This app simply scratches the surface on what is possible with React
          </li>
          <li>
